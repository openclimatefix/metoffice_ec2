...
def test_single_level_wind(single_level_wind_message):
    ...
    assert (
        ...
        == "var_name=wind_speed; is_multi_level=False; object_size=3.2 MB; model=mo-atmospheric-mogreps-uk-prd; SQS_message_sent_timestamp=2020-05-29 23:36:29.372000+01:00; forecast_reference_time=2020-05-28T20:00:00Z; created_time=2020-05-28T22:26:08Z; time=2020-06-01T08:00:00Z; source_url=aws-earth-mo-atmospheric-mogreps-uk-prd/fd0640a8c5570a63424e07d2ca4f30b1d4c00692.nc; SQS_approx_receive_count=1; SQS_message_ID=6ad940c2-41bd-4fd2-bad6-76cd7a741ad8"
    )
