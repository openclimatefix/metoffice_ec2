...
def find_zarr(fs: fsspec.spec.AbstractFileSystem, directory: str) -> List[str]:
    """Find all the zarr files in a filesystem directory"""
    return [dir for dir in fs.listdir(directory, detail=False) if dir.endswith(".zarr")]
